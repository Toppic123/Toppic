...
export const homeTexts = {
  ...
  nearbyContestsDesc: "Explora el mapa para encontrar concursos en tu área y participa fácilmente.",
  howItWorks: "¿Cómo funciona?",
  participate: "1. Participa",
  participateDesc: "Regístrate y sube tus mejores fotos a concursos activos cerca de tu ubicación.",
  vote: "2. Vota",
  voteDesc: "Explora fotos de otros participantes y vota por tus favoritas usando nuestro sistema de votación.",
  win: "3. Gana",
  winDesc: "Los ganadores reciben recompensas especiales y reconocimiento de los organizadores.",
