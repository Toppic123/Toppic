            ...
            <div className="flex justify-center">
              ...
              >
                <Button 
                  asChild 
                  size="lg" 
                  className="bg-[#f46464] hover:bg-[#e45555] text-white px-8 py-6 text-lg font-bold rounded-full shadow-2xl transform transition-all duration-300 hover:scale-105"
                >
